...
/// -----------------------------------------
///
PlusMark::PlusMark(GLWidget277 *context):Drawable(context),pluslength(0.15)
{}
...
//    pls_vert_pos[3]=glm::vec4(0,-pluslength*0.5,0,1);
    ...
    pls_vert_data[0]=glm::vec4(pluslength*0.5*ratio,0,0,1);
    pls_vert_data[1]=glm::vec4(0,0,0,0);
    //pls_vert_data[2]=glm::vec4(1.0f);
    pls_vert_data[2]=color;
    pls_vert_data[3]=glm::vec4(1.0f);
    pls_vert_data[4]=glm::vec4(1.0f);

    pls_vert_data[5]=glm::vec4(-pluslength*0.5*ratio,0,0,1);
    pls_vert_data[6]=glm::vec4(0,0,0,0);
    //pls_vert_data[7]=glm::vec4(1.0f);
    pls_vert_data[7]=color;
    pls_vert_data[8]=glm::vec4(1.0f);
    pls_vert_data[9]=glm::vec4(1.0f);

    pls_vert_data[10]=glm::vec4(0,pluslength*0.5,0,1);
    pls_vert_data[11]=glm::vec4(0,0,0,0);
//    pls_vert_data[12]=glm::vec4(1.0f);
    pls_vert_data[12]=color;
    pls_vert_data[13]=glm::vec4(1.0f);
    pls_vert_data[14]=glm::vec4(1.0f);

    pls_vert_data[15]=glm::vec4(0,-pluslength*0.5,0,1);
    pls_vert_data[16]=glm::vec4(0,0,0,0);
//    pls_vert_data[17]=glm::vec4(1.0f);
    pls_vert_data[17]=color;
    pls_vert_data[18]=glm::vec4(1.0f);
    pls_vert_data[19]=glm::vec4(1.0f);
    count=4;
   ...
   // context->glBindBuffer(GL_ARRAY_BUFFER, bufCol);
    ...
    context->glBufferData(GL_ARRAY_BUFFER, 20 * sizeof(glm::vec4), pls_vert_data, GL_STATIC_DRAW);
