...
public:
    ...
    Joint* initWithJSON(QJsonObject jointJSON, Joint* parent);
    Joint* loadJSON(QString path);
...
public slots:
    ...
    virtual void slot_loadSkeleton();
    virtual void slot_bindMesh();
    virtual void slot_updateVertex();
