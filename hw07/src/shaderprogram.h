...
public:
    ...
    // Pass the given transformation matrix to this shader on the GPU
    void setTransformationMatrix(const glm::mat4 transMats[100]);
    // Pass the given bind matrix to this shader on the GPU
    void setBindMatrix(const glm::mat4 bindMats[100]);
